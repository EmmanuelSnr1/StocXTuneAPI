...
public class User {
    ...
    public void buy(Asset asset, Integer quantity, Double buyPrice) {

        System.out.println(this + " buying " + quantity + " of " + asset + " at " + buyPrice);

        Investment previousInvestment = null;

        for (Investment investment : investments)
            if (investment.getAsset().equals(asset)) {
        ...
        if (previousInvestment != null)
            ...
            this.invest(new Investment(asset, quantity, buyPrice, this));
    ...
    public void sell(Asset asset, Integer quantity, Double sellingPrice) throws IllegalArgumentException {
        ...
        if (ownedInvestment == null)
            throw new IllegalArgumentException("You don't own this asset");

        if (quantity > ownedInvestment.getQuantity())
            throw new IllegalArgumentException("You don't own enough quantity of this asset");
    ...
    public Optional<Investment> getInvestmentFromStock(String stockSymbol) {
        ...
        for (Investment i : this.getInvestments()) {
            if (i.getAsset().getSymbol().equals(stockSymbol))
